...
/*
 * Locate a MR from cache.
 * Try to find a MR first. If not found, register a new MR.
 */
struct mana_mr_cache *
mana_locate_pmd_mr(struct mana_mr_btree *local_mr_btree, struct mana_priv *priv,
